    ...
    async function fetchData() {
      try {
        ...
        if (isSignedIn && user) {
          ...
          const membershipsMap: Record<string, MembershipDocument> = {};
      ...
      <main className="min-h-screen">
        ...
        <section className="relative h-[40vh] flex items-center justify-center">
          ...
          <div className="relative z-10 text-center text-white">
            ...
            >
              Join our elite CrossFit community and transform your fitness
              journey
            </motion.p>
          </div>
        </section>

        {/* Pricing Section with Skeleton */}
          ...
          <div className="container px-4 mx-auto">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 mb-16">
              {durations.map((duration) => (
                <Button
                  key={duration.value}
                  variant={duration.value === "month" ? "default" : "outline"}
                  className={`
            ...
            <div className="max-w-3xl mx-auto space-y-8">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  No, we don't charge any signup or initiation fees. The price
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  plans, cancellation will take effect at the end of your
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  year. Contact our support team to arrange this.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">
